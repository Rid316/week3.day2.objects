...
heroCreator.createCharSheet = function (hero) {
    // Create a div with className 'hero_container'
    let heroDiv = document.createElement('div');
    heroDiv.className = 'hero_container';
    // Create an image element
    let heroImg = document.createElement('img');
    heroImg.src = `assets/${hero.img}`
    heroDiv.appendChild(heroImg);

    // createInfoDiv
    let infoDiv = this.createInfoDiv(hero)
